  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto">
          <ScrollSection className="rounded-3xl bg-card/60 backdrop-blur-md border border-border/40 shadow-card p-8 md:p-14 space-y-10">
            <div className="space-y-4 max-w-4xl mx-auto text-center">
              ...
              <p className="animate-fade-in-up animation-delay-200 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto" style={{ fontFamily: 'var(--font-body)', color: 'hsl(150 8% 25%)' }}>
              ...
              <p className="animate-fade-in-up animation-delay-300 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto" style={{ fontFamily: 'var(--font-body)', color: 'hsl(150 8% 25%)' }}>
                The system then reflects their emotions in a gentle and meaningful way.
              </p>
              <div className="animate-fade-in-up animation-delay-400 flex gap-2 pt-1 justify-center">
      ...
      <section className="relative z-10 pt-8 md:pt-12 pb-32 md:pb-44 px-6">
        <div className="max-w-[1400px] mx-auto">
          <ScrollSection className="rounded-3xl bg-card/60 backdrop-blur-md border border-border/40 shadow-card p-8 md:p-14 flex flex-col items-center justify-center gap-8 py-16 md:py-24">
