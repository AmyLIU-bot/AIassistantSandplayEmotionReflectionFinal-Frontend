        ...
        <div className="flex-1 min-h-0 px-4 md:px-8 pb-4 md:pb-5">
          <div className="w-full max-w-7xl mx-auto h-full grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-4 lg:gap-5">
            ...
            <div className="animate-fade-in-up animation-delay-200 h-full min-h-0 flex">
              <Card className="shadow-card border-0 backdrop-blur-sm bg-card/95 w-full flex flex-col">
                <CardHeader className="pb-2 pt-5 md:pt-6 px-5 md:px-6 shrink-0">
                ...
                <CardContent className="flex-1 flex flex-col px-5 md:px-6 pb-5 md:pb-6">
                  <form onSubmit={handleLogin} className="flex-1 flex flex-col justify-between gap-4">
                    ...
                    <div className="space-y-3">
                      <Button type="submit" className="w-full h-10 text-base font-semibold rounded-lg">Login</Button>
                      <div className="relative flex items-center">
                        <div className="flex-1 border-t border-border" />
                        <span className="px-3 text-xs text-muted-foreground">or</span>
                        <div className="flex-1 border-t border-border" />
                      </div>
                      <Button type="button" variant="google" className="w-full h-10 text-base font-medium rounded-lg gap-3" onClick={() => navigate("/home")}>
